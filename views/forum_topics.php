...
<!--<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createTopicModal">Erstellen</button> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="createTopicForm" action="/controllers/forum.php" method="post">
          <input type="hidden" name="action" value="createTopic">
          <input type="hidden" name="bereich_id" value="<?php echo htmlspecialchars($bereich_id); ?>">
          <div class="mb-3">
            <label for="title" class="form-label">Titel *</label>
            <input type="text" class="form-control" id="title" name="title" required>
          </div>
